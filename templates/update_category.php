	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <h5 class="modal-title" id="exampleModalLabel">Edit Category<small id="add_error" class="form-text text-muted"></small></h5>
	      ...
	      <div class="modal-body">
	        <form id="update_category_form" onsubmit="return false">
			  <div class="form-group">
			    ...
			    <input type="text" class="form-control" name="update_category" id="update_category" placeholder="Enter Category">
